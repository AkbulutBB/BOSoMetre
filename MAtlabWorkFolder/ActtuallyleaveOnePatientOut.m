...
filePath = 'G:\My Drive\Neuropapers\Githubstuff\BOSoMetre\MAtlabWorkFolder\FixedBosometreData.csv'; % Replace with your file path
...
labels = data.ExtraBinaryInfected; % Infection status
